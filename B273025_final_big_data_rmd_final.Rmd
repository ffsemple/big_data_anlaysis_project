---
title: "Assessment: Predicting Length of Stay for Hospitalised Covid-19 Patients Using Random Forest Machine Learning"
author: "B273025"
date: "2024-11-16"
output: 
  pdf_document:
...
summarise_big_data <- function(sdf, cardinality_limit = 15) {
  ...
  metrics <- purrr::map_dfr(schema, ~ {
    ...
    categories_str <- if (cardinality < cardinality_limit) {
      ...
      NA}  # Skip for high-cardinality columns
